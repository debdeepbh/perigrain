...
# msh.trim(min_rad = 0.8*1e-3 + min_particle_spacing/2, max_rad = None)
# msh.info()
...
SL.append(shape=shape_dict.perturbed_disk(seed=1), count=msh.count(), meshsize=meshsize, material=material_dict.peridem(delta))
# SL.append(shape=shape_dict.plus(ratio=0.3), count=msh.count(), meshsize=meshsize, material=material_dict.peridem(delta))
# SL.append(shape=shape_dict.plus_inscribed(notch_dist=0.3), count=msh.count(), meshsize=meshsize, material=material_dict.peridem(delta))
