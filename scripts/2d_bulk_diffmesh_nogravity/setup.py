...
# plus_inscribed(notch_dist=0.2)
        ...
        SL.append(shape=shape_dict.wheel_annulus(scaling=msh.incircle_rad[i], inner_circle_ratio=0.7, meshsize=meshsize), count=1, meshsize=meshsize, material=material_dict.peridem_deformable(delta, Gnot_scale=0.5, rho_scale=0.8))
