...
# plus_inscribed(notch_dist=0.2)
    ...
    elif sys.argv[1] == 'ring0.3':
        SL.append(shape=shape_dict.wheel_annulus(scaling=msh.incircle_rad[i], inner_circle_ratio=0.3, meshsize=meshsize, filename_suffix=str(i)), count=1, meshsize=meshsize, material=material_dict.peridem_deformable(delta, Gnot_scale=0.5, rho_scale=0.8))
    ...
    elif sys.argv[1] == 'ring0.5':
        SL.append(shape=shape_dict.wheel_annulus(scaling=msh.incircle_rad[i], inner_circle_ratio=0.5, meshsize=meshsize, filename_suffix=str(i)), count=1, meshsize=meshsize, material=material_dict.peridem_deformable(delta, Gnot_scale=0.5, rho_scale=0.8))
    elif sys.argv[1] == 'ring0.6':
        SL.append(shape=shape_dict.wheel_annulus(scaling=msh.incircle_rad[i], inner_circle_ratio=0.6, meshsize=meshsize, filename_suffix=str(i)), count=1, meshsize=meshsize, material=material_dict.peridem_deformable(delta, Gnot_scale=0.5, rho_scale=0.8))
    elif sys.argv[1] == 'ring0.7':
        SL.append(shape=shape_dict.wheel_annulus(scaling=msh.incircle_rad[i], inner_circle_ratio=0.7, meshsize=meshsize, filename_suffix=str(i)), count=1, meshsize=meshsize, material=material_dict.peridem_deformable(delta, Gnot_scale=0.5, rho_scale=0.8))
