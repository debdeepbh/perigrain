...
save_filename = '/home/debdeep/gdrive/work/peridynamics/granular/data/3d-collision-damping-CurrPos.png'
plt.plot(tt, ua, label = 'A')
plt.plot(tt, ub, label = 'B')
plt.xlabel(r'Time ($\mu$s)')
plt.ylabel(r'Position of center (m)')
...
save_filename = '/home/debdeep/gdrive/work/peridynamics/granular/data/3d-collision-damping-vel.png'
plt.plot(tt, va, label = 'A')
plt.plot(tt, vb, label = 'B')
plt.xlabel(r'Time ($\mu$s)')
plt.ylabel(r'Velocity of center (m)')
